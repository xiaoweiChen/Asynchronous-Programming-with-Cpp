...
\mySubsection{1.2.}{了解分类、技术和模型}{content/part1/chapter1/2.tex}
\mySubsection{1.3.}{了解各种并行编程范式}{content/part1/chapter1/3.tex}
\mySubsection{1.4.}{探索评估并行性的指标}{content/part1/chapter1/4.tex}
...
\mySubsection{1.1.}{Linux 中的进程}{content/part1/chapter2/1.tex}
\mySubsection{1.2.}{Linux 中的服务和守护进程}{content/part1/chapter2/2.tex}
\mySubsection{1.3.}{线程}{content/part1/chapter2/3.tex}
\mySubsection{1.4.}{同步原语}{content/part1/chapter2/4.tex}
\mySubsection{1.5.}{使用多线程时的常见问题}{content/part1/chapter2/5.tex}
\mySubsection{1.6.}{有效线程管理的策略}{content/part1/chapter2/6.tex}
...
\mySubsection{4.2.}{了解竞争条件}{content/part2/chapter4/2.tex}
